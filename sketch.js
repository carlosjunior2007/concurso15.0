...
// boton de reinio
  if(touches.length > 0 || keyDown("r")){
      a=0;
      lander.visible=true;
      lander.x=displayWidth-displayWidth+100;
      lander.y=displayHeight-displayHeight;
      touches =[];
  }
...
// mensaje de inicio para el jugador 
  if(a===2){
    ...
    textSize(24);
    text("Al llegar a 20 puntos tendras una habilidad extra",displayWidth/4,displayHeight/4);
